...
tmp/_output/bin/percona-server-mongodb-operator: pkg/apis/psmdb/v1alpha1/zz_generated.deepcopy.go pkg/apis/psmdb/v1alpha1/*.go pkg/*/*.go version/version.go cmd/percona-server-mongodb-operator/main.go
