...
2. We store the documentation as *.rst files in the [K8s-PSMDB-docs](https://github.com/percona/percona-server-mongodb-operator/tree/K8s-PSMDB-docs) branch of the Operator GitHub repository.
