...
func getShardingSans(cr *api.PerconaServerMongoDB) []string {
	return []string{
		...
		"*." + cr.Name + "-mongos" + "." + cr.Namespace,
		"*." + cr.Name + "-mongos" + "." + cr.Namespace + "." + cr.Spec.ClusterServiceDNSSuffix,
		cr.Name + "-" + cr.Spec.Sharding.ConfigsvrReplSet.RFC1123Name(),
		cr.Name + "-" + cr.Spec.Sharding.ConfigsvrReplSet.RFC1123Name() + "." + cr.Namespace,
		cr.Name + "-" + cr.Spec.Sharding.ConfigsvrReplSet.RFC1123Name() + "." + cr.Namespace + "." + cr.Spec.ClusterServiceDNSSuffix,
		"*." + cr.Name + "-" + cr.Spec.Sharding.ConfigsvrReplSet.RFC1123Name(),
		"*." + cr.Name + "-" + cr.Spec.Sharding.ConfigsvrReplSet.RFC1123Name() + "." + cr.Namespace,
		"*." + cr.Name + "-" + cr.Spec.Sharding.ConfigsvrReplSet.RFC1123Name() + "." + cr.Namespace + "." + cr.Spec.ClusterServiceDNSSuffix,
	}
