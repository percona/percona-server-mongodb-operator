...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CollectionIndex) DeepCopyInto(out *CollectionIndex) {
	*out = *in
	if in.Keys != nil {
	...
	if in.PartialFilterExpression != nil {
		in, out := &in.PartialFilterExpression, &out.PartialFilterExpression
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CollectionIndex.
func (in *CollectionIndex) DeepCopy() *CollectionIndex {
	if in == nil {
		return nil
	}
	out := new(CollectionIndex)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CollectionStatus) DeepCopyInto(out *CollectionStatus) {
	*out = *in
	if in.IndexesStatus != nil {
		in, out := &in.IndexesStatus, &out.IndexesStatus
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatabaseCollection) DeepCopyInto(out *DatabaseCollection) {
	*out = *in
	if in.Validator != nil {
	...
	if in.Indexes != nil {
		...
		*out = make([]CollectionIndex, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatabaseCollection.
func (in *DatabaseCollection) DeepCopy() *DatabaseCollection {
	if in == nil {
		return nil
	}
	out := new(DatabaseCollection)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MongoDBDatabaseSpec) DeepCopyInto(out *MongoDBDatabaseSpec) {
	*out = *in
	...
	if in.Collections != nil {
		...
		*out = make([]DatabaseCollection, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MongoDBDatabaseStatus) DeepCopyInto(out *MongoDBDatabaseStatus) {
	*out = *in
	...
	if in.CollectionsStatus != nil {
		in, out := &in.CollectionsStatus, &out.CollectionsStatus
...
func (in *MongoDBUserSpec) DeepCopyInto(out *MongoDBUserSpec) {
	*out = *in
	...
	if in.DatabaseAccess != nil {
		in, out := &in.DatabaseAccess, &out.DatabaseAccess
		*out = make([]UserDatabaseAccess, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserDatabaseAccess) DeepCopyInto(out *UserDatabaseAccess) {
	*out = *in
	if in.Roles != nil {
		in, out := &in.Roles, &out.Roles
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserDatabaseAccess.
func (in *UserDatabaseAccess) DeepCopy() *UserDatabaseAccess {
	if in == nil {
		return nil
	}
	out := new(UserDatabaseAccess)
	in.DeepCopyInto(out)
	return out
}
