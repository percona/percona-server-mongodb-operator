...
func (in *PerconaServerMongoDBStatus) DeepCopyInto(out *PerconaServerMongoDBStatus) {
	*out = *in
	...
	if in.VaultLastRequestedAt != nil {
		in, out := &in.VaultLastRequestedAt, &out.VaultLastRequestedAt
		*out = (*in).DeepCopy()
	}
}
...
func (in *VaultSpec) DeepCopyInto(out *VaultSpec) {
	*out = *in
	...
	if in.ReinitInterval != nil {
		in, out := &in.ReinitInterval, &out.ReinitInterval
