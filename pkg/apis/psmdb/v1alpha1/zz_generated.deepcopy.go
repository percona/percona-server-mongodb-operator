...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplsetBackupSpec) DeepCopyInto(out *ReplsetBackupSpec) {
	*out = *in
	if in.ResourcesSpec != nil {
		in, out := &in.ResourcesSpec, &out.ResourcesSpec
		*out = new(ResourcesSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplsetBackupSpec.
func (in *ReplsetBackupSpec) DeepCopy() *ReplsetBackupSpec {
	if in == nil {
		return nil
	}
	out := new(ReplsetBackupSpec)
	in.DeepCopyInto(out)
	return out
}
