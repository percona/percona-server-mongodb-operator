...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupSpecRotate) DeepCopyInto(out *BackupSpecRotate) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupSpecRotate.
func (in *BackupSpecRotate) DeepCopy() *BackupSpecRotate {
	if in == nil {
		return nil
	}
	out := new(BackupSpecRotate)
