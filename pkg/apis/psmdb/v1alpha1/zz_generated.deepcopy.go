...
func (in *PerconaServerMongoDBSpec) DeepCopyInto(out *PerconaServerMongoDBSpec) {
	*out = *in
	if in.UserAdmin != nil {
		in, out := &in.UserAdmin, &out.UserAdmin
		*out = new(PerconaServerMongoDBSpecCredential)
		**out = **in
	}
	...
	if in.ClusterMonitor != nil {
		in, out := &in.ClusterMonitor, &out.ClusterMonitor
		*out = new(PerconaServerMongoDBSpecCredential)
		**out = **in
	}
	if in.AddUsers != nil {
		in, out := &in.AddUsers, &out.AddUsers
		*out = make([]PerconaServerMongoDBSpecCredential, len(*in))
		copy(*out, *in)
	}
	if in.MongoDB != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PerconaServerMongoDBSpecCredential) DeepCopyInto(out *PerconaServerMongoDBSpecCredential) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PerconaServerMongoDBSpecCredential.
func (in *PerconaServerMongoDBSpecCredential) DeepCopy() *PerconaServerMongoDBSpecCredential {
	if in == nil {
		return nil
	}
	out := new(PerconaServerMongoDBSpecCredential)
...
func (in *PerconaServerMongoDBSpecMongoDB) DeepCopyInto(out *PerconaServerMongoDBSpecMongoDB) {
	*out = *in
	...
	if in.OperationProfiling != nil {
		...
		*out = new(PerconaServerMongoDBSpecMongoDBOperationProfiling)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PerconaServerMongoDBSpecMongoDBOperationProfiling) DeepCopyInto(out *PerconaServerMongoDBSpecMongoDBOperationProfiling) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PerconaServerMongoDBSpecMongoDBOperationProfiling.
func (in *PerconaServerMongoDBSpecMongoDBOperationProfiling) DeepCopy() *PerconaServerMongoDBSpecMongoDBOperationProfiling {
	if in == nil {
		return nil
	}
	out := new(PerconaServerMongoDBSpecMongoDBOperationProfiling)
