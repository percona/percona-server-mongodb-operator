...
func (in *BackupAWSSpec) DeepCopyInto(out *BackupAWSSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupAWSSpec.
func (in *BackupAWSSpec) DeepCopy() *BackupAWSSpec {
	if in == nil {
		return nil
	}
	out := new(BackupAWSSpec)
	in.DeepCopyInto(out)
	return out
}
